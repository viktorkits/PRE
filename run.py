...
from Odoo_testing_3_horas import Odoo_testing_3_horas
...
odoo_test_3 = unittest.TestLoader().loadTestsFromTestCase(Odoo_testing_3_horas)

final_tests = unittest.TestSuite([odoo_test_0, odoo_test_1, odoo_test_2, odoo_test_3])
